    ...
    <>
      ...
      <div>
        <input
          ...
          placeholder="key"
          style={style}
          onChange={(event) => updateParamsHander(event.target.value, 'key')}
        />
        <input
          type="text"
          placeholder="value"
          style={style}
          onChange={(event) => updateParamsHander(event.target.value, 'value')}
        />
        <input
          type="text"
          placeholder="des"
          style={style}
          onChange={(event) =>
            updateParamsHander(event.target.value, 'description')
          }
        />
      </div>
    </>
